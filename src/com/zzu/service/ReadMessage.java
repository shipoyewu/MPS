...
@WebServlet(name="ReadMessage",urlPatterns="/ReadMessage")
public class ReadMessage extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		RD.Read(messageid, groupid);
		System.out.println(messageid+" "+groupid);
		System.out.println("shihasdasdasdasdasdu");
	}
