...
public interface UserDao 
{
	...
	public boolean confUser(int userid,String password);//校验用户信息
	public boolean confUser(String email,String password);//校验用户信息
	
	public ArrayList<Object> getAllSendMeg(int userid);//返回该用户所有发送的信息
	public ArrayList<Object> getAllVote(int voteid);//返回发起的所有投票
}
